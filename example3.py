...
box = Bin('Bin', 5, 1, 6, 100,0)
#  add item
# Item('item name', (W,H,D), Weight, Packing Priority level, load bear, Upside down or not , 'item color')
packer.add_bin(box)
packer.add_item(Item('Box-1', (2, 1, 3), 1, 1, False, True, 'yellow'))
packer.add_item(Item('Box-2', (2, 1, 3), 1, 1, False, True, 'pink'))
packer.add_item(Item('Box-3', (2, 1, 3), 1, 1, False, True, 'brown'))
packer.add_item(Item('Box-4', (2, 1, 3), 1, 1, False, True, 'cyan'))
