...
packer.add_bin(box)
packer.add_item(Item(name='Box-1',typeof='test', WHD=(4, 1, 3), weight=1, level=1,loadbear=100, updown=True, color='yellow'))
packer.add_item(Item(name='Box-2',typeof='test', WHD=(6, 1, 2), weight=1, level=1,loadbear=100, updown=True, color='pink'))
