...
packer.addItem(Item(partno='Box-2', name='test', typeof='cylinder', WHD=(2, 2, 6), weight=1, level=2,loadbear=100, updown=True, color='pink'))
...
packer.addItem(Item(partno='Box-5', name='test', typeof='cylinder', WHD=(1,1 , 6), weight=1, level=1,loadbear=100, updown=True, color='olive'))
